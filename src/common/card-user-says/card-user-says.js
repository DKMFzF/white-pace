...
function addClassInCardUserSays(card, cardItem) {
    const cardUserPlaceWork = cardItem.querySelector('.card-user-says__container-user-place-work');
    switch (card.name) {
        case 'avatar-1':
            cardItem.querySelector('.card-user-says__img').classList.add('card-user-says__img_avatar-inset-first');
            ...
            break;
        case 'avatar-2':
            cardItem.querySelector('.card-user-says__img').classList.add('card-user-says__img_avatar-inset-second');
            addClassCompanyInCardUsers(
                card, 
                cardUserPlaceWork, 
            ...
            break;
        case 'avatar-3':
            cardItem.querySelector('.card-user-says__img').classList.add('card-user-says__img_avatar-inset-third');
            addClassCompanyInCardUsers(
                card, 
                cardUserPlaceWork, 
...
function addClassCompanyInCardUsers(card, cardUserPlaceWork, ...className) {
    ...
    if (textLine.length !== className.length) return console.log('ERROR: NONE CARD');
